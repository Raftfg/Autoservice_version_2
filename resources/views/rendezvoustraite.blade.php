                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rendevous" name="motif" placeholder="Donner le motif de votre rendez-vous " style="border: 2px solid blue;" required>
                                        @if ($errors->has('motif'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rendevous">Date du rendez-vous</label> <span style="color: red;">*</span>
                                        <input type="date" class="form-control" id="rendevous" name="rendevous"  placeholder="choisir une date " style="border: 2px solid blue;" required>
                                        @if ($errors->has('rendevous'))
                                        <p class="alert alert-danger">{{ $errors->first('rendevous')}}</p>
                                      @endif
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" placeholder="Votre email" id="email" class="form-control" name="email" style="border: 2px solid blue;" required>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Nom et Prénom</label> <span style="color: red;">*</span>
                                        <input type="text" placeholder="Votre nom et prénom" id="name" class="form-control" name="name" value="" size="40" style="border: 2px solid blue;" required>
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Téléphone" id="telephone" class="form-control" name="telephone" value="" size="40" style="border: 2px solid blue;" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" name="messages" placeholder="Votre Message ff" rows="4" style="border: 2px solid blue;" required>
                                        </textarea> 

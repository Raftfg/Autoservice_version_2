 ...
 <div class="about-box-main">
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-lg-6 ">
                ...
                <p class="te">
                    ...
                    </strong>et la <strong>maintenance de véhicules</strong>, la <strong>rénovation</strong>, dans la région de cotonou.
                    Nous garantissons un travail sérieux et nous intervenons <strong>7 jours sur 7</strong> et <strong>24 heures sur 24</strong>.
                </p>
        ...
        <div class="row my-2" >
            <div class=" col-md-4">
                <div class="service-block-inner">
                    ...
                    <p class="te">
                        Etre reconnue en tant que garage automobile offrant des services accessibles et complets, avec une approche personnalisée typique des commerces de proximité, tout en utilisant
                        des méthodes et des appareils à la fine pointe de la technologie, tels que trouvés dans les grandes chaînes de mécanique automobile et les concessionnaires.
                    </p>
                     <p class="te ">
                        Notre mission est d'offrir un service de mécanique automobile personnalisé, courtois, fiable et exemplaire, afin d'assurer que nos clients puissent se rendre où ils veulent aller, en tout sécurité.
                    </p>
                </div>
            </div>
            <div class=" col-md-4">
                <div class="service-block-inner">
                    ...
                    <p class="te">
                        Notre principal objectif de service de réparation automobile est de fournir des services de réparation et d'entretien automobile de qualité aux clients pour assurer le bon fonctionnement et la sécurité de leur véhicule. Voici quelques-uns des objectifs spécifiques de notre service de réparation automobile:
                        <span style="font-weight: bold" >diagnostiquer et résoudre les problèmes mécaniques</span>, <span style="font-weight: bold" >fournir des services d'entretien</span>, <span style="font-weight: bold" >utiliser des pièces de qualité</span>, offrir un service client de qualité, respecter les normes de sécurité et rester à l'affût des tendances et des nouveautés.  
                ...
                <div class="service-block-inner">
                    ...
                    <p class="te">
                        Les valeurs de notre service de réparation automobile inclurent:
                         la <span style="font-weight: bold" >qualité</span>, la <span style="font-weight: bold" >fiabilité</span>, <span style="font-weight: bold" >l'honnêteté</span>, le <span style="font-weight: bold" >service à la clientèle</span>, le <span style="font-weight: bold" >respect de l'environnement</span>, <span style="font-weight: bold" >l'éthique professionnelle</span> et <span style="font-weight: bold" >l'innovation</span>.  
                    </p>
                    <p class="te">
                        Il est convaincu qu'il est tout à faire possible et avantageux pour notre entreprise et notre équipe de combiner les valeurs de confiance et de service axé sur les besoins et attentes de la clientèle avec une stratégie de performance et d'optimisation des services.
                        Faites un tour au garage  <span style="font-weight:bold" >ASP</span>  pour une expérience inoubliable.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row my-4 ">
                ...
                <div class="col-12 col-md-3 mb-4 ">
                    <div class="hover-team code_equipe" style="box-shadow: 0 0 25px rgba(0, 0, 0, 0.1);">
                        ...
                        <div class="team-description">
                            <p class="te">{{ $equipe->description }}</p>
            ...
            <div class="row my-2">
                <div class="col-12">
                    <h2 class="noo-sh-title text-primary " style="margin-left: 16px;">Message du chef garagiste</h2>
                    <p class="te" style="margin-top: -30px; margin-left: 16px;"> « Chez Auto Service la Patience, nous mettons tout en œuvre pour assurer votre confort et votre sécurité lorsque vous conduisez votre véhicule. »</p>
                </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <p class="te">La plupart des systèmes et dispositifs qui composent les véhicules automobiles d’aujourd’hui sont 
                            de plus en plus complexes. Il est donc important que l’évaluation des problèmes et la réparation
                             de votre véhicule soient faits par des techniciens automobiles expérimentés et des outils à la fine
                              pointe de la technologie.</p>
                       
                        <p class="te"> Chez ASP (Auto Service la Patience), tous nos techniciens sont certifiés. Ils ont reçu une excellente formation pour identifier, évaluer et effectuer tous les types de réparations automobiles, 
                            qu’ils soient d’origine mécaniques, électriques ou électroniques. De plus, ils savent comment 
                            utiliser avec une grande précision nos équipements et nos systèmes de diagnostics électroniques.  Le perfectionnement de nos employés étant une priorité, nous leur offrons des formations de mises à
                            jour des connaissances et des procédures, au moins une fois par année. Ainsi, 
                            nous sommes toujours au courant des nouvelles technologies et pouvons les appliquer dans nos services à
                            nos clients.</p>
                    </div>
                </div>
            </div>
         ...
         <div class="row my-3">
            <div class="col-xl-6 col-lg-6 col-md-6 ">
                <div class="single-product-details">
                    ...
                    <p class="te"> Nos techniciens sont tous certifiés offrant des services personnalisés basés sur la communication et l’honnêteté. Nous possédons aussi un système              
                            de diagnostic électronique, des outils et équipements à la fine pointe de la technologie et des pièces automobiles de qualité égale ou supérieure aux pièces d’origine.
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="{{ route('articlee.show', $article->id) }}"><h3 class="ouib">{{ $article->titre }}</h3></a>
                                <p class="te truncated">{{ $article->contenu }}</p>
                            </div>
                        </div>
...
<!-- End Instagram Feed  -->
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .modal-contentM {
                width: 90%; /* Réduit la largeur du modal sur les écrans plus petits */
                margin: 20% auto; /* Décale le modal un peu plus bas sur mobile */
            }
    
            .intro {
                font-size: 0.9rem; /* Augmente légèrement la taille de la police sur mobile */
            }
    
            .inpu {
                height: 3rem; /* Augmente la hauteur des champs de saisie pour mobile */
            }
    
            .labe {
                font-size: 0.75rem; /* Réduit la taille de la police du label sur mobile */
            }
    
            .bouton {
                font-size: 0.9rem; /* Augmente légèrement la taille du bouton */
                padding: 0.7rem; /* Améliore la lisibilité et l'ergonomie sur mobile */
            }
        }
    
        @media (max-width: 480px) {
            .modal-contentM {
                width: 95%; /* Réduit encore la largeur pour les très petits écrans */
                padding: 15px;
            }
    
            .intro {
                font-size: 1rem; /* Taille de police plus grande pour les très petits écrans */
                padding: 0 10px; /* Ajoute un peu de padding pour éviter le texte trop collé */
            }
    
            .bouton {
                font-size: 1rem; /* Ajuste la taille du bouton pour une meilleure visibilité */
            }
    
            .inpu {
                height: 3.5rem; /* Augmente la taille de l'input pour un meilleur confort de saisie */
            }
        }
    </style>

        ...
        <div class="row my-5">
            ...
            <div class="col-xl-7 col-lg-7 col-md-6">
                <div class="single-product-details">
                    ...
                    <p class="text-justify">La plupart des systèmes et dispositifs qui composent les véhicules automobiles d’aujourd’hui sont 
                    ...
                    <p class="text-justify"> Chez ASP (Auto Service la Patience), tous nos techniciens sont certifiés. Ils ont reçu une excellente formation pour identifier, évaluer et effectuer tous les types de réparations automobiles, 
         ...
         <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="single-product-details">
                    ...
                    <p class="text-justify"> 
                    Votre système d’échappement, vos freins et votre suspension, votre climatisation, votre moteur et son système d’injection,
votre batterie et son système de charge, votre radiateur et son système de refroidissement, votre servo-direction.</p>

...
@section('contenu')
    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
            <!-- Multi Columns Form -->
            <form class="row g-3" action="{{route('rendez_vous.store')}}" method="post">
                @csrf
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" required id="motif" name="motif">
                    @if ($errors->has('motif'))
                ...
                <div class="col-md-4">
                    ...
                    <input type="time" class="form-control" required id="heure" name="heure">
                    @if ($errors->has('heure'))
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" required id="entreprise" name="entreprise">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" name="date_rendez_vous" id="date_rendez_vous">

...
@section('contenu')
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">Ajouter un paramètre</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-lg-12">
            <!-- Multi Columns Form -->
            <form class="row g-3" enctype="multipart/form-data" action="{{route('parametres.store')}}" method="post">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" class="form-control" required id="header_image_1" name="header_image_1">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" class="form-control" required id="header_image_2" name="header_image_2">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" class="form-control" required id="header_image_3" name="header_image_3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="file" class="form-control" required id="about_image" name="about_image">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="about_texte" id="about_texte" cols="15" rows="2"></textarea>

...
<header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between">
        <a href="/" class="logo d-flex align-items-center">
            ...
            <img src="{{asset('assets/autoimages/logoremo.png')}}" >
            <span class="d-none d-lg-block">ASP ADMIN</span>
        </a>
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center" method="POST" action="/search">
            @csrf
            <input type="text" class="typeahead" data-provide="typeahead" name="words" id="words" placeholder="Rechercher" title="Enter search keyword">

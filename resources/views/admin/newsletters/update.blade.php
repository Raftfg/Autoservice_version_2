...
@section('contenu')
    ...
    <main id="main" class="main">
        <div class="pagetitle">
        <h1>Modifier un newsletter</h1>
        <nav>
            <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/home">Accueil</a></li>
            <li class="breadcrumb-item">Newsletters</li>
            <li class="breadcrumb-item active">Modifier un newsletter</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-lg-12">
            <!-- Multi Columns Form -->
            <form class="row g-3" action="{{route('newsletters.update',[$letter->id])}}" method="post">
                @csrf
                <input type="hidden" name="_method" value="PUT">
                <div class="col-md-6">
                    <label for="mail" class="form-label">Mail<span style="color: red">*</span> </label>
                    <input type="mail" class="form-control" required id="mail" value="{{$letter->email}}" name="mail">
                    @if ($errors->has('mail'))

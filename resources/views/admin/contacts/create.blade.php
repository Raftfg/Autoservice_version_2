        ...
        <div class="row">
            ...
            <form class="row g-3" action="{{route('contacts.store')}}" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="suggestion" id="suggestion" cols="15" rows="2"></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="message" id="message" cols="15" rows="2"></textarea>

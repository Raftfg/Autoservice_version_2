...
@section('contenu')
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">Ajouter un sous-service</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-lg-12">
            <!-- Multi Columns Form -->
            <form class="row g-3" enctype="multipart/form-data" action="{{route('services_photo.store')}}" method="post">
                @csrf
                <div class="col-md-6">
                    <label for="designation" class="form-label">Désignation<span style="color: red">*</span> </label>
                    <input type="text" class="form-control" required id="nom" name="designation">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary">Ajouter un sous-service</button>
                </div>
            </form>
            </div>
        </div>

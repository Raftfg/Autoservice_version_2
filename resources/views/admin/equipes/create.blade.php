...
@section('contenu')
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">Ajouter une equipe</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-lg-12">
            <!-- Multi Columns Form -->
            <form class="row g-3" enctype="multipart/form-data" action="{{route('equipes.store')}}" method="post">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="qualification" required id="qualification">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control" required id="gmail" name="gmail">
                    @if ($errors->has('gmail'))
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="description" id="description" cols="15" rows="2"></textarea>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Ajouter une equipe</button>
                    </div>
                </form>
            </div>
        </div>
